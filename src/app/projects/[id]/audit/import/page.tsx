  ...
  return (
    ...
    >
      ...
      {showViewBlog && effectiveBlogId && (
        <ProjectNavLink href={`/projects/${projectId}/content-generator/blogs/${effectiveBlogId}${BLOG_QUERY_FROM_ANALYZE_CONTENT}`}
  ...
  async function onUploadSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (res.success && res.blogId) {
        ...
        router.push(`/projects/${projectId}/content-generator/blogs/${res.blogId}${BLOG_QUERY_FROM_ANALYZE_CONTENT}`);
        return;
      }
            ...
            <div className="space-y-2">
              {uploadHistory.map(entry => (
                ...
                >
                  ...
                  <ProjectNavLink
                    href={`/projects/${projectId}/content-generator/blogs/${entry.blogId}${BLOG_QUERY_FROM_ANALYZE_CONTENT}`}
