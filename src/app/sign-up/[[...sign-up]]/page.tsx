  ...
  return (
    <div className="min-h-screen bg-surface-primary flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-[15%] right-[20%] w-[400px] h-[400px] rounded-full bg-accent-500/10 blur-[100px] animate-pulse-glow" />
        <div className="absolute bottom-[10%] left-[15%] w-[350px] h-[350px] rounded-full bg-brand-500/8 blur-[100px] animate-pulse-glow [animation-delay:4s]" />
      </div>
      ...
      <div className="relative z-10 w-full max-w-md mx-auto px-4">
        ...
        <div className="text-center mb-8 animate-fade-in-up">
          ...
          <p className="text-text-tertiary text-sm mt-3">Create your account and start automating SEO.</p>
        </div>
