...
function ToggleRow({
  ...
  return (
    <label
      className={cn(
        "flex items-center justify-between gap-4 py-2.5 border-b border-border-subtle last:border-0",
...
export function AdminSettingsDashboard() {
  ...
  const isOwner = meQuery.data ? platformAdminMeetsMinRole(meQuery.data.role, "owner") : false;
    ...
    <PageShell
      ...
      subtitle={
        canEdit
          ...
          : "View-only — owner role required to edit."
      }
    >
      <div className="space-y-6">
          ...
          {PROVIDER_LABELS.map(({ key, label }) => (
            <ToggleRow
              ...
              onChange={(v) =>
                setDraft({
                  ...draft,
                  providers: { ...draft.providers, [key]: v },
                })
              }
            />
          ))}
        ...
        <Card padding="md">
          ...
          <ToggleRow
            ...
            disabled={!canEdit}
            onChange={(v) =>
              setDraft({ ...draft, debug: { ...draft.debug, ai_logging_full_prompts: v } })
            }
          />
          ...
          <div className="mt-4">
            <ToggleRow
              ...
              onChange={(v) =>
                setDraft({
                  ...draft,
                  maintenance: { ...draft.maintenance, enabled: v },
                })
              }
            />
