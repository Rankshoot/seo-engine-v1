          ...
          <div className="grid grid-cols-1 gap-3">
            ...
            <div className="rounded-xl border border-border-subtle bg-surface-primary p-4 opacity-50 select-none">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="flex items-center gap-2 mb-0.5">
                    <span className="text-[14px] font-semibold text-text-primary">WordPress</span>
                  ...
                  <p className="text-[12px] text-text-tertiary">Publish directly to WordPress via REST API.</p>
                </div>
              </div>
            </div>
