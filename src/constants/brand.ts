/**
 * Rankit brand constants — single source of truth for product name, tagline,
...
export const BRAND = {
  ...
  description:
    "Rankit is an AI-native SEO operating system that researches keywords, audits competitors, plans your editorial calendar, and ships ranked content — automatically.",
  /** Hostname placeholder shown in mockups (browser chrome). */
  marketingDomain: "rankit.ai",
  /** Years to render in copyright. */
  copyrightStart: 2026,
  /** Lightning bolt + Rankit wordmark uses these two characters as glyphs. */
  glyph: "R",
} as const;
