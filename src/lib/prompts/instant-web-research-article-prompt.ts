...
You choose the single best format for this topic and primary keyword (news vs guide vs comparison vs glossary, etc.). Pick one coherent shape and execute it fully. ${common}`;
    case 'news':
      return `SELECTED ARTICLE FORMAT: ${articleTypeLabel} (${articleTypeId})
Write as a timely news or news-analysis piece (not evergreen filler).
...
- Avoid sounding like a generic marketing blog; keep a factual, editorial tone aligned with ${articleTypeLabel}.
${common}`;
    case 'blog':
      return `SELECTED ARTICLE FORMAT: ${articleTypeLabel} (${articleTypeId})
Write as a thoughtful editorial blog: strong point of view, narrative flow, and relatable examples.
...
${common}`;
    case 'howto':
      return `SELECTED ARTICLE FORMAT: ${articleTypeLabel} (${articleTypeId})
Write as a practical how-to or tutorial.
...
${common}`;
    case 'listicle':
      return `SELECTED ARTICLE FORMAT: ${articleTypeLabel} (${articleTypeId})
Write as a high-signal listicle (not clickbait).
...
${common}`;
    case 'comparison':
      return `SELECTED ARTICLE FORMAT: ${articleTypeLabel} (${articleTypeId})
Write as a comparison or "vs" article.
...
${common}`;
    case 'technical':
      return `SELECTED ARTICLE FORMAT: ${articleTypeLabel} (${articleTypeId})
Write as a technical deep-dive for practitioners.
...
${common}`;
    case 'product_review':
      return `SELECTED ARTICLE FORMAT: ${articleTypeLabel} (${articleTypeId})
Write as a balanced product or solution review.
...
${common}`;
    case 'glossary':
      return `SELECTED ARTICLE FORMAT: ${articleTypeLabel} (${articleTypeId})
Write as a glossary or definitions hub centered on the topic.
...
${common}`;
    default:
      return `SELECTED ARTICLE FORMAT: ${articleTypeLabel} (${articleTypeId})
Shape the article to match the label above while satisfying all global requirements. ${common}`;
  }
}
